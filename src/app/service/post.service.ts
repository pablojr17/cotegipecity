...
export class PostService {
  private posts = [
    { id: 1, title: 'História de Cotegipe', content: 'História. A região era primitivamente habitada pelos índios acroás. O território integrava a sesmaria da Casa da Ponte. Seu povoamento iniciou-se na primeira metade do século XVIII, por aventureiros procedentes da Província de Pernambuco, que se estabeleceram à margem do Rio Grande, desenvolvendo a agropecuária.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRG5Cs--HmVRCYOb0M-jvSi3HDXtjmPiUle2g&s' },
